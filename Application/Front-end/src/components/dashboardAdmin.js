...
// import Index from './hotel/index'
import Repas from './indexRepas'
import User from './indexUser'
 ...
 const SlideStyle = {
    ...
    return (
                ...
                <div className="px-8"style={SlideStyle}>
                    ...
                    <ul className="mt-12">
                        <li className="flex w-full justify-between text-gray-300 hover:text-gray-500 cursor-pointer items-center mb-6">
                            <div onClick={handleUser} className="flex items-center">
                                <span className="text-sm  ml-2">Users</span>
                            </div>
                            <div className="py-1 px-3 bg-gray-700 rounded text-gray-500 flex items-center justify-center text-xs"></div>
                        </li>
                        <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
                            <div onClick={handleRepas} className="flex items-center">
                                <span className="text-sm  ml-2">Repas</span>
                            </div>
                        </li>
                        <li className="flex w-full justify-between text-gray-600 hover:text-gray-500 cursor-pointer items-center mb-6">
        ...
        <ul id="menu">
          ...
          <MenuContainer link={"/dashboard"} icon={<Chat />} />
